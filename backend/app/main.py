...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:3000",
        "http://localhost:8000",  # Another development server
        "http://localhost:8080",  # Another development server
        "http://localhost:5173",  # Vite dev server

        "http://127.0.0.1:3000",
        "http://127.0.0.1:8000",  # Another development server
        "http://127.0.0.1:8080",  # Another development server
        "http://127.0.0.1:5173",  # Vite dev server with custom port
